...
| Median words per page (content only, excluding nav/byline/disclosure) | 300 | 953 |
| Mean words per page | 569 | 1109 |
| Pages under 400 words | 40 | 9 |
...
Of the 9 remaining "thin" pages, 4 are app entry or utility pages that are not articles (`/discover.html`, `/collections.html`, `/contact.html`, `/author/kerem-toker.html`). The 5 thin articles left are `ysl-libre-dupes` (218), `best-date-night-fragrances` (239), `vanilla-in-perfumery` (268), `what-is-oud` (339) and `best-summer-fragrances` (371).
...
9. **Placeholders filled** — the `KEREM:` comments on the About and author pages were replaced with text based only on what is known (founder, started 2025, runs it alone, loves perfume). No city, collection size, first bottle or photo was invented; the author page keeps a monogram avatar until a photo is added.

## 3. Remaining risks

- **Five thin articles remain** (`ysl-libre-dupes`, `best-date-night-fragrances`, `vanilla-in-perfumery`, `what-is-oud`, `best-summer-fragrances`, all under 400 words). Deepen them the same way or merge them (YSL Libre into the BR540/Sauvage pattern, date-night and summer into the men's/women's pillars) before resubmitting.
...
6. Deal with the five remaining thin articles (deepen or merge, see Remaining risks).
